...
// =================================================================
// CCpuUsageItem implementation (Full and Correct)
// =================================================================
...
// =================================================================
// CNvidiaLimitReasonItem implementation (with WHEA logic)
// =================================================================
...
const wchar_t* CCPUCoreBarsPlugin::GetInfo(PluginInfoIndex index)
{
    ...
    case TMI_DESCRIPTION: return L"显示CPU核心使用率和NVIDIA GPU/WHEA状态。";
    case TMI_AUTHOR: return L"Your Name";
    case TMI_COPYRIGHT: return L"Copyright (C) 2025";
    case TMI_URL: return L"";
    case TMI_VERSION: return L"2.5.0";
    default: return L"";
    }
}
